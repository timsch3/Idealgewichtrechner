function calc() {
    ...
    if (height > 100 && age > 12) {
        ...
        document.getElementById('output').innerHTML = `Dein Idealgewicht beträgt ${result.toFixed(0)}kg.<br><br><strong>Aber denk dran:</strong> du bist schön,<br>egal wie viel du wiegst!`
    }
    else {
